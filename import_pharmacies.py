...
# Usage:
# python import_pharmacies.py /path/to/hlbcpharmaciesfeb282018.csv
#   (from https://catalogue.data.gov.bc.ca/
#      dataset/after-hours-pharmacies-in-bc/resource/
#      681b4fa5-13a5-4273-a189-fc101f0f8356)
